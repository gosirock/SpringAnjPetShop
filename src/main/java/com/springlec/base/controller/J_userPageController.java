...
//		String userid = "bono";
		...
		J_userDto userInfo = service.userInfo(userid);
		J_ordersDto orderMileage = service.orderMileage(userid);
...
//		System.out.println("userdetailaddress : " + userdetailaddress);
		...
		service.updateInfo(userid, userpasswd, usertel, useremail, userpostcode, useraddress, userdetailaddress);
