...
public interface J_uPageDaoService {
	...
	public void updateInfo(String userpasswd, String usertel, String useremail, int userpostcode, String useraddress, String userdetailaddress) throws Exception;
